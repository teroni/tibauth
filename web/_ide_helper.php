 ...
 * Generated for Laravel 5.0.33 on 2015-09-09.
 *
...
namespace {
    ...
    class Config extends \Illuminate\Support\Facades\Config{
         ...
         */
        public static function get($key, $default = null){
            return \Cartalyst\CompositeConfig\Repository::get($key, $default);
        }
         ...
         * @static 
         */
        public static function persist($key, $value = null){
            \Cartalyst\CompositeConfig\Repository::persist($key, $value);
        }
        
        /**
         * Returns the database connection.
         *
         * @return \Cartalyst\CompositeConfig\Illuminate\Database\Connection 
         * @static 
         */
        public static function getDatabase(){
            return \Cartalyst\CompositeConfig\Repository::getDatabase();
        }
        
        /**
         * Sets the database connection.
         *
         * @param \Cartalyst\CompositeConfig\Illuminate\Database\Connection $database
         * @return void 
         * @static 
         */
        public static function setDatabase($database){
            \Cartalyst\CompositeConfig\Repository::setDatabase($database);
        }
        ...
        public static function getDatabaseTable(){
            \Cartalyst\CompositeConfig\Repository::getDatabaseTable();
        }
         ...
         * @static 
         */
        public static function setDatabaseTable($databaseTable){
            \Cartalyst\CompositeConfig\Repository::setDatabaseTable($databaseTable);
        }
         ...
         * @static 
         */
        public static function fetchAndCache(){
            \Cartalyst\CompositeConfig\Repository::fetchAndCache();
        }
        ...
        public static function has($key){
            ...
            return \Cartalyst\CompositeConfig\Repository::has($key);
        }
        ...
        public static function set($key, $value = null){
            //Method inherited from \Illuminate\Config\Repository            
            \Cartalyst\CompositeConfig\Repository::set($key, $value);
        }
        ...
        public static function prepend($key, $value){
            //Method inherited from \Illuminate\Config\Repository            
            \Cartalyst\CompositeConfig\Repository::prepend($key, $value);
        }
        ...
        public static function push($key, $value){
            //Method inherited from \Illuminate\Config\Repository            
            \Cartalyst\CompositeConfig\Repository::push($key, $value);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Config\Repository            
            return \Cartalyst\CompositeConfig\Repository::all();
        }
        ...
        public static function offsetExists($key){
            //Method inherited from \Illuminate\Config\Repository            
            return \Cartalyst\CompositeConfig\Repository::offsetExists($key);
        }
        ...
        public static function offsetGet($key){
            //Method inherited from \Illuminate\Config\Repository            
            return \Cartalyst\CompositeConfig\Repository::offsetGet($key);
        }
        ...
        public static function offsetSet($key, $value){
            //Method inherited from \Illuminate\Config\Repository            
            \Cartalyst\CompositeConfig\Repository::offsetSet($key, $value);
        }
        ...
        public static function offsetUnset($key){
            //Method inherited from \Illuminate\Config\Repository            
            \Cartalyst\CompositeConfig\Repository::offsetUnset($key);
        }
    ...
    class Redirect extends \Illuminate\Support\Facades\Redirect{
        ...
        public static function home($status = 302){
            ...
            return \Cartalyst\Platform\Redirector::home($status);
        }
        ...
        public static function back($status = 302, $headers = array()){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::back($status, $headers);
        }
        ...
        public static function refresh($status = 302, $headers = array()){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::refresh($status, $headers);
        }
        ...
        public static function guest($path, $status = 302, $headers = array(), $secure = null){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::guest($path, $status, $headers, $secure);
        }
        ...
        public static function intended($default = '/', $status = 302, $headers = array(), $secure = null){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::intended($default, $status, $headers, $secure);
        }
        ...
        public static function to($path, $status = 302, $headers = array(), $secure = null){
            return \Cartalyst\Platform\Redirector::to($path, $status, $headers, $secure);
        }
        ...
        public static function away($path, $status = 302, $headers = array()){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::away($path, $status, $headers);
        }
        ...
        public static function secure($path, $status = 302, $headers = array()){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::secure($path, $status, $headers);
        }
        ...
        public static function route($route, $parameters = array(), $status = 302, $headers = array()){
            return \Cartalyst\Platform\Redirector::route($route, $parameters, $status, $headers);
        }
        ...
        public static function action($action, $parameters = array(), $status = 302, $headers = array()){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::action($action, $parameters, $status, $headers);
        }
        ...
        public static function getUrlGenerator(){
            //Method inherited from \Illuminate\Routing\Redirector            
            return \Cartalyst\Platform\Redirector::getUrlGenerator();
        }
        ...
        public static function setSession($session){
            //Method inherited from \Illuminate\Routing\Redirector            
            \Cartalyst\Platform\Redirector::setSession($session);
        }
        ...
        public static function toAdmin($path, $status = 302, $headers = array(), $secure = null){
            return \Cartalyst\Platform\Redirector::toAdmin($path, $status, $headers, $secure);
        }
    ...
    class URL extends \Illuminate\Support\Facades\URL{
        ...
        public static function previous($fallback = null){
            return \Cartalyst\Platform\UrlGenerator::previous($fallback);
        }
        ...
        public static function full(){
            ...
            return \Cartalyst\Platform\UrlGenerator::full();
        }
        ...
        public static function current(){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::current();
        }
        ...
        public static function to($path, $extra = array(), $secure = null){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::to($path, $extra, $secure);
        }
        ...
        public static function secure($path, $parameters = array()){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::secure($path, $parameters);
        }
        ...
        public static function asset($path, $secure = null){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::asset($path, $secure);
        }
        ...
        public static function secureAsset($path){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::secureAsset($path);
        }
        ...
        public static function forceSchema($schema){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            \Cartalyst\Platform\UrlGenerator::forceSchema($schema);
        }
        ...
        public static function route($name, $parameters = array(), $absolute = true){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::route($name, $parameters, $absolute);
        }
        ...
        public static function action($action, $parameters = array(), $absolute = true){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::action($action, $parameters, $absolute);
        }
        ...
        public static function forceRootUrl($root){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            \Cartalyst\Platform\UrlGenerator::forceRootUrl($root);
        }
        ...
        public static function isValidUrl($path){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::isValidUrl($path);
        }
        ...
        public static function getRequest(){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::getRequest();
        }
        ...
        public static function setRequest($request){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            \Cartalyst\Platform\UrlGenerator::setRequest($request);
        }
        ...
        public static function setRoutes($routes){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::setRoutes($routes);
        }
        ...
        public static function setSessionResolver($sessionResolver){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::setSessionResolver($sessionResolver);
        }
        ...
        public static function setRootControllerNamespace($rootNamespace){
            //Method inherited from \Illuminate\Routing\UrlGenerator            
            return \Cartalyst\Platform\UrlGenerator::setRootControllerNamespace($rootNamespace);
        }
         ...
         * @static 
         */
        public static function setAdminUri($adminUri){
            \Cartalyst\Platform\UrlGenerator::setAdminUri($adminUri);
        }
         ...
         * @static 
         */
        public static function toAdmin($path, $parameters = array(), $secure = null){
            return \Cartalyst\Platform\UrlGenerator::toAdmin($path, $parameters, $secure);
        }
    ...
    class Extension extends \Cartalyst\Extensions\Extension{
        
    }


    class Extensions extends \Cartalyst\Extensions\Laravel\Facades\Extensions{
        ...
        public static function create($file){
            return \Cartalyst\Extensions\ExtensionBag::create($file);
        }
        ...
        public static function register($extension){
            \Cartalyst\Extensions\ExtensionBag::register($extension);
        }
         ...
         * @static 
         */
        public static function sortExtensions(){
            \Cartalyst\Extensions\ExtensionBag::sortExtensions();
        }
         ...
         * @static 
         */
        public static function findAndRegisterExtensions(){
            \Cartalyst\Extensions\ExtensionBag::findAndRegisterExtensions();
        }
         ...
         * @static 
         */
        public static function allUninstalled(){
            return \Cartalyst\Extensions\ExtensionBag::allUninstalled();
        }
        ...
        public static function allInstalled(){
            return \Cartalyst\Extensions\ExtensionBag::allInstalled();
        }
        ...
        public static function allDisabled(){
            return \Cartalyst\Extensions\ExtensionBag::allDisabled();
        }
        ...
        public static function allEnabled(){
            return \Cartalyst\Extensions\ExtensionBag::allEnabled();
        }
         ...
         */
        public static function setContainer($container){
            \Cartalyst\Extensions\ExtensionBag::setContainer($container);
        }
         ...
         */
        public static function getContainer(){
            return \Cartalyst\Extensions\ExtensionBag::getContainer();
        }
        ...
        public static function make($items = null){
            ...
            return \Cartalyst\Extensions\ExtensionBag::make($items);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::all();
        }
        ...
        public static function collapse(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::collapse();
        }
        ...
        public static function contains($key, $value = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::contains($key, $value);
        }
        ...
        public static function diff($items){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::diff($items);
        }
        ...
        public static function each($callback){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::each($callback);
        }
        ...
        public static function fetch($key){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::fetch($key);
        }
        ...
        public static function filter($callback){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::filter($callback);
        }
        ...
        public static function where($key, $value, $strict = true){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::where($key, $value, $strict);
        }
        ...
        public static function whereLoose($key, $value){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::whereLoose($key, $value);
        }
        ...
        public static function first($callback = null, $default = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::first($callback, $default);
        }
        ...
        public static function flatten(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::flatten();
        }
        ...
        public static function flip(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::flip();
        }
        ...
        public static function forget($key){
            //Method inherited from \Illuminate\Support\Collection            
            \Cartalyst\Extensions\ExtensionBag::forget($key);
        }
        ...
        public static function get($key, $default = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::get($key, $default);
        }
        ...
        public static function groupBy($groupBy){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::groupBy($groupBy);
        }
        ...
        public static function keyBy($keyBy){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::keyBy($keyBy);
        }
        ...
        public static function has($key){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::has($key);
        }
        ...
        public static function implode($value, $glue = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::implode($value, $glue);
        }
        ...
        public static function intersect($items){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::intersect($items);
        }
        ...
        public static function isEmpty(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::isEmpty();
        }
        ...
        public static function keys(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::keys();
        }
        ...
        public static function last(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::last();
        }
        ...
        public static function lists($value, $key = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::lists($value, $key);
        }
        ...
        public static function map($callback){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::map($callback);
        }
        ...
        public static function merge($items){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::merge($items);
        }
        ...
        public static function forPage($page, $perPage){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::forPage($page, $perPage);
        }
        ...
        public static function pop(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::pop();
        }
        ...
        public static function prepend($value){
            //Method inherited from \Illuminate\Support\Collection            
            \Cartalyst\Extensions\ExtensionBag::prepend($value);
        }
        ...
        public static function push($value){
            //Method inherited from \Illuminate\Support\Collection            
            \Cartalyst\Extensions\ExtensionBag::push($value);
        }
        ...
        public static function pull($key, $default = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::pull($key, $default);
        }
        ...
        public static function put($key, $value){
            //Method inherited from \Illuminate\Support\Collection            
            \Cartalyst\Extensions\ExtensionBag::put($key, $value);
        }
        ...
        public static function random($amount = 1){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::random($amount);
        }
        ...
        public static function reduce($callback, $initial = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::reduce($callback, $initial);
        }
        ...
        public static function reject($callback){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::reject($callback);
        }
        ...
        public static function reverse(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::reverse();
        }
        ...
        public static function search($value, $strict = false){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::search($value, $strict);
        }
        ...
        public static function shift(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::shift();
        }
        ...
        public static function shuffle(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::shuffle();
        }
        ...
        public static function slice($offset, $length = null, $preserveKeys = false){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::slice($offset, $length, $preserveKeys);
        }
        ...
        public static function chunk($size, $preserveKeys = false){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::chunk($size, $preserveKeys);
        }
        ...
        public static function sort($callback){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::sort($callback);
        }
        ...
        public static function sortBy($callback, $options = 0, $descending = false){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::sortBy($callback, $options, $descending);
        }
        ...
        public static function sortByDesc($callback, $options = 0){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::sortByDesc($callback, $options);
        }
        ...
        public static function splice($offset, $length = 0, $replacement = array()){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::splice($offset, $length, $replacement);
        }
        ...
        public static function sum($callback = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::sum($callback);
        }
        ...
        public static function take($limit = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::take($limit);
        }
        ...
        public static function transform($callback){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::transform($callback);
        }
        ...
        public static function unique(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::unique();
        }
        ...
        public static function values(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::values();
        }
        ...
        public static function toArray(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::toArray();
        }
        ...
        public static function jsonSerialize(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::jsonSerialize();
        }
        ...
        public static function toJson($options = 0){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::toJson($options);
        }
        ...
        public static function getIterator(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::getIterator();
        }
        ...
        public static function getCachingIterator($flags = 1){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::getCachingIterator($flags);
        }
        ...
        public static function count(){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::count();
        }
        ...
        public static function offsetExists($key){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::offsetExists($key);
        }
        ...
        public static function offsetGet($key){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::offsetGet($key);
        }
        ...
        public static function offsetSet($key, $value){
            //Method inherited from \Illuminate\Support\Collection            
            \Cartalyst\Extensions\ExtensionBag::offsetSet($key, $value);
        }
        ...
        public static function offsetUnset($key){
            //Method inherited from \Illuminate\Support\Collection            
            \Cartalyst\Extensions\ExtensionBag::offsetUnset($key);
        }
        
    }


    class Filesystem extends \Cartalyst\Filesystem\Laravel\Facades\Filesystem{
         ...
         */
        public static function connection($name = null){
            return \Cartalyst\Filesystem\FilesystemManager::connection($name);
        }
        ...
        public static function getMaxFileSize(){
            return \Cartalyst\Filesystem\FilesystemManager::getMaxFileSize();
        }
        ...
        public static function setMaxFileSize($size){
            return \Cartalyst\Filesystem\FilesystemManager::setMaxFileSize($size);
        }
        ...
        public static function getAllowedMimes(){
            return \Cartalyst\Filesystem\FilesystemManager::getAllowedMimes();
        }
         ...
         * @static 
         */
        public static function setAllowedMimes($mimes){
            return \Cartalyst\Filesystem\FilesystemManager::setAllowedMimes($mimes);
        }
        ...
        public static function getPlaceholders(){
            return \Cartalyst\Filesystem\FilesystemManager::getPlaceholders();
        }
         ...
         * @static 
         */
        public static function setPlaceholders($placeholders){
            return \Cartalyst\Filesystem\FilesystemManager::setPlaceholders($placeholders);
        }
         ...
         * @static 
         */
        public static function getDispersion(){
            return \Cartalyst\Filesystem\FilesystemManager::getDispersion();
        }
         ...
         * @static 
         */
        public static function setDispersion($dispersion){
            return \Cartalyst\Filesystem\FilesystemManager::setDispersion($dispersion);
        }
         ...
         */
        public static function getDefaultConnection(){
            return \Cartalyst\Filesystem\FilesystemManager::getDefaultConnection();
        }
        ...
        public static function setDefaultConnection($connection){
            return \Cartalyst\Filesystem\FilesystemManager::setDefaultConnection($connection);
        }
    ...
    class Theme extends \Cartalyst\Themes\Laravel\Facades\Theme{
         ...
         * Get an iterator for the items.
         *
         * @return \Cartalyst\Themes\ArrayIterator 
         * @static 
         */
        public static function getIterator(){
    ...
    class Widget extends \Cartalyst\Widgets\Laravel\Facades\Widget{
        ...
        public static function make($key, $parameters = array()){
            return \Cartalyst\Widgets\WidgetResolver::make($key, $parameters);
        }
         ...
         * @static 
         */
        public static function map($key, $item){
            \Cartalyst\Widgets\WidgetResolver::map($key, $item);
        }
         ...
         * @static 
         */
        public static function autoDetect($key){
            \Cartalyst\Widgets\WidgetResolver::autoDetect($key);
        }
         ...
         * @static 
         */
        public static function parseKey($key, $namespacePrefix = null){
            return \Cartalyst\Widgets\WidgetResolver::parseKey($key, $namespacePrefix);
        }
         ...
         */
        public static function offsetGet($key){
            return \Cartalyst\Widgets\WidgetResolver::offsetGet($key);
        }
        
    }


    class Installer extends \Platform\Installer\Laravel\Facades\Installer{
        ...
        public static function getRepository(){
            return \Platform\Installer\Installer::getRepository();
        }
        ...
        public static function setRepository($repository){
            return \Platform\Installer\Installer::setRepository($repository);
        }
        ...
        public static function getUserData(){
            return \Platform\Installer\Installer::getUserData();
        }
         ...
         * @static 
         */
        public static function setUserData($data = array()){
            return \Platform\Installer\Installer::setUserData($data);
        }
         ...
         * @static 
         */
        public static function getDatabaseData($driver = null){
            return \Platform\Installer\Installer::getDatabaseData($driver);
        }
         ...
         * @static 
         */
        public static function setDatabaseData($driver, $data = array()){
            return \Platform\Installer\Installer::setDatabaseData($driver, $data);
        }
        ...
        public static function getDatabaseDrivers(){
            return \Platform\Installer\Installer::getDatabaseDrivers();
        }
        ...
        public static function validate(){
            return \Platform\Installer\Installer::validate();
        }
         ...
         * @static 
         */
        public static function install($testing = false){
            \Platform\Installer\Installer::install($testing);
        }
         ...
         */
        public static function before($callback){
            \Platform\Installer\Installer::before($callback);
        }
         ...
         * @static 
         */
        public static function after($callback, $priority = 0){
            \Platform\Installer\Installer::after($callback, $priority);
        }
         ...
         * @static 
         */
        public static function updatePlatformInstalledVersion($version){
            \Platform\Installer\Installer::updatePlatformInstalledVersion($version);
        }
         ...
         * @static 
         */
        public static function replaceConfigStringValue($string, $key, $value){
            return \Platform\Installer\Installer::replaceConfigStringValue($string, $key, $value);
        }
        
    }


    class Page extends \Platform\Pages\Models\Page{
        
    }


    class Platform extends \Platform\Foundation\Laravel\Facades\Platform{
        ...
        public static function beforeBoot(){
            \Platform\Foundation\Platform::beforeBoot();
        }
         ...
         */
        public static function boot(){
            \Platform\Foundation\Platform::boot();
        }
        ...
        public static function afterBoot(){
            \Platform\Foundation\Platform::afterBoot();
        }
         ...
         * @static 
         */
        public static function setupExtensions(){
            \Platform\Foundation\Platform::setupExtensions();
        }
         ...
         * @static 
         */
        public static function bootExtensions(){
            \Platform\Foundation\Platform::bootExtensions();
        }
        ...
        public static function updateExtensions(){
            \Platform\Foundation\Platform::updateExtensions();
        }
        ...
        public static function isInstalled(){
            return \Platform\Foundation\Platform::isInstalled();
        }
         ...
         */
        public static function isBooted(){
            return \Platform\Foundation\Platform::isBooted();
        }
        ...
        public static function installedVersion(){
            return \Platform\Foundation\Platform::installedVersion();
        }
         ...
         * @static 
         */
        public static function codebaseVersion(){
            return \Platform\Foundation\Platform::codebaseVersion();
        }
        ...
        public static function needsUpgrade(){
            return \Platform\Foundation\Platform::needsUpgrade();
        }
         ...
         * @static 
         */
        public static function checkRunningEligibility(){
            return \Platform\Foundation\Platform::checkRunningEligibility();
        }
         ...
         * @static 
         */
        public static function getExtensionBag(){
            return \Platform\Foundation\Platform::getExtensionBag();
        }
         ...
         * @static 
         */
        public static function addEligibilityWhitelist($uri){
            \Platform\Foundation\Platform::addEligibilityWhitelist($uri);
        }
         ...
         * @static 
         */
        public static function getEligibilityWhitelist(){
            return \Platform\Foundation\Platform::getEligibilityWhitelist();
        }
        ...
        public static function getLicense(){
            return \Platform\Foundation\Platform::getLicense();
        }
         ...
         * @static 
         */
        public static function ineligible($callback){
            \Platform\Foundation\Platform::ineligible($callback);
        }
         ...
         */
        public static function booting($callback){
            \Platform\Foundation\Platform::booting($callback);
        }
         ...
         */
        public static function booted($callback){
            \Platform\Foundation\Platform::booted($callback);
        }
        
    }


    class Social extends \Cartalyst\Sentinel\Addons\Social\Laravel\Facades\Social{
         ...
         * @static 
         */
        public static function make($slug, $callbackUri){
            return \Cartalyst\Sentinel\Addons\Social\Manager::make($slug, $callbackUri);
        }
         ...
         * @static 
         */
        public static function getAuthorizationUrl($slug, $callbackUri){
            return \Cartalyst\Sentinel\Addons\Social\Manager::getAuthorizationUrl($slug, $callbackUri);
        }
         ...
         * @static 
         */
        public static function authenticate($slug, $callbackUri, $callback = null, $remember = false){
            return \Cartalyst\Sentinel\Addons\Social\Manager::authenticate($slug, $callbackUri, $callback, $remember);
        }
        ...
        public static function registering($callback){
            \Cartalyst\Sentinel\Addons\Social\Manager::registering($callback);
        }
        ...
        public static function registered($callback){
            \Cartalyst\Sentinel\Addons\Social\Manager::registered($callback);
        }
         ...
         * @static 
         */
        public static function existing($callback){
            \Cartalyst\Sentinel\Addons\Social\Manager::existing($callback);
        }
         ...
         * @static 
         */
        public static function linking($callback){
            \Cartalyst\Sentinel\Addons\Social\Manager::linking($callback);
        }
         ...
         * @static 
         */
        public static function addConnection($slug, $connection){
            \Cartalyst\Sentinel\Addons\Social\Manager::addConnection($slug, $connection);
        }
        ...
        public static function addConnections($connections){
            \Cartalyst\Sentinel\Addons\Social\Manager::addConnections($connections);
        }
         ...
         * @static 
         */
        public static function getConnection($slug){
            return \Cartalyst\Sentinel\Addons\Social\Manager::getConnection($slug);
        }
         ...
         */
        public static function getConnections(){
            return \Cartalyst\Sentinel\Addons\Social\Manager::getConnections();
        }
         ...
         * @static 
         */
        public static function getLinksRepository(){
            return \Cartalyst\Sentinel\Addons\Social\Manager::getLinksRepository();
        }
         ...
         * @static 
         */
        public static function setLinksRepository($links){
            \Cartalyst\Sentinel\Addons\Social\Manager::setLinksRepository($links);
        }
         ...
         */
        public static function getDispatcher(){
            return \Cartalyst\Sentinel\Addons\Social\Manager::getDispatcher();
        }
         ...
         */
        public static function setDispatcher($dispatcher){
            return \Cartalyst\Sentinel\Addons\Social\Manager::setDispatcher($dispatcher);
        }
         ...
         */
        public static function getDispatcherStatus(){
            return \Cartalyst\Sentinel\Addons\Social\Manager::getDispatcherStatus();
        }
         ...
         */
        public static function setDispatcherStatus($status){
            return \Cartalyst\Sentinel\Addons\Social\Manager::setDispatcherStatus($status);
        }
         ...
         */
        public static function enableDispatcher(){
            return \Cartalyst\Sentinel\Addons\Social\Manager::enableDispatcher();
        }
         ...
         */
        public static function disableDispatcher(){
            return \Cartalyst\Sentinel\Addons\Social\Manager::disableDispatcher();
        }
    ...
    class Interpret extends \Cartalyst\Interpret\Laravel\Facades\Interpreter{
         ...
         * @param string $value
         * @param string $format
         * @return \Cartalyst\Interpret\Cartalyst\Interpret\Content\ContentInterface 
         * @static 
         */
        public static function make($value, $format = null){
            return \Cartalyst\Interpret\Interpreter::make($value, $format);
        }
         ...
         * @static 
         */
        public static function getContentMappings(){
            return \Cartalyst\Interpret\Interpreter::getContentMappings();
        }
         ...
         * @static 
         */
        public static function addContentMapping($class, $formats){
            \Cartalyst\Interpret\Interpreter::addContentMapping($class, $formats);
        }
         ...
         * @static 
         */
        public static function addFormatsToContentMapping($class, $formats){
            \Cartalyst\Interpret\Interpreter::addFormatsToContentMapping($class, $formats);
        }
         ...
         */
        public static function getFallback(){
            return \Cartalyst\Interpret\Interpreter::getFallback();
        }
         ...
         */
        public static function setFallback($fallback){
            \Cartalyst\Interpret\Interpreter::setFallback($fallback);
        }
