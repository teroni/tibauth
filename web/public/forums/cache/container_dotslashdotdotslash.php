...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'auth.provider.oauth.service.tib' => 'getAuth_Provider_Oauth_Service_TibService',
    ...
    /**
     * Gets the 'auth.provider.oauth.service.tib' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\auth\provider\oauth\service\tib A phpbb\auth\provider\oauth\service\tib instance.
     */
    protected function getAuth_Provider_Oauth_Service_TibService()
    {
        return $this->services['auth.provider.oauth.service.tib'] = new \phpbb\auth\provider\oauth\service\tib($this->get('config'), $this->get('request'));
    }
    ...
    protected function getAuth_Provider_Oauth_ServiceCollectionService()
    {
        ...
        $instance->add('auth.provider.oauth.service.tib');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('45.33.16.194', 'tibforums', 'tibauth1', 'tibforums', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => '45.33.16.194',
            'dbal.dbuser' => 'tibforums',
            'dbal.dbpasswd' => 'tibauth1',
            'dbal.dbname' => 'tibforums',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
